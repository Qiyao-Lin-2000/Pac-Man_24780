// test_map_adaptive.cpp
// 自适应窗口大小的测试程序 - 修复版（APP 版本）
...
extern "C" int RunMapTestAdaptive(void) {
    ...
    std::cout << "=== 自适应窗口设置 ===" << std::endl;
    std::cout << "地图尺寸: " << mapWidth << " x " << mapHeight << " tiles" << std::endl;
    std::cout << "Tile大小: " << tileSize << " pixels" << std::endl;
